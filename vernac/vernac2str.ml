...
let vernac_expr_type = function
  ...
  | Vernacexpr.VernacDeclareImplicits _ -> "VernacDeclareImplicits"
  | Vernacexpr.VernacSyntacticDefinition _ -> "VernacSyntacticDefinition"
  | Vernacexpr.VernacArguments _ -> "VernacArguments"
  | Vernacexpr.VernacArgumentsScope _ -> "VernacArgumentsScope"
  ...
  | Vernacexpr.VernacBacktrack _ -> "VernacBacktrack"
  ...
  | Vernacexpr.VernacToplevelControl _ -> "VernacToplevelControl"
